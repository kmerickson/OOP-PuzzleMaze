...
class TestOutline(unittest.TestCase):
    ...
    def test_draw(self, mock_font_obj) -> None:
        ...
        with patch.object(text.screen, 'blit') as mock_blit, patch.object(text, 'draw') as mock_draw:
            outline.draw()
...
class TestButton(unittest.TestCase):
    ...
    @patch('pygame.font.Font')
    def test_draw(self, mock_font_obj, mock_load) -> None:
        mock_font = MagicMock()
        mock_font_obj.return_value = mock_font
        mock_font.render.return_value = self._mock_screen
        text = Text(**self._text_parameters)
    ...
    @patch('pygame.image.load')
    @patch('pygame.font.Font')
    def test_dynamically_draw(self, mock_font_obj, mock_load) -> None:
        mock_font = MagicMock()
        mock_font_obj.return_value = mock_font
        mock_font.render.return_value = self._mock_screen
        text = Text(**self._text_parameters)
    ...
    @patch('pygame.image.load')
    @patch('pygame.font.Font')
    def test_adjust_to_changes(self, mock_font_obj, mock_load, mock_scale) -> None:
        mock_font = MagicMock()
        mock_font_obj.return_value = mock_font
        mock_font.render.return_value = self._mock_screen
        text = Text(**self._text_parameters)
